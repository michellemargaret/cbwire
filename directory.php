<?php 
   ...
   $strMetaTitle = "Directory on cbwire.ca";
    $strMetaDescription = "Post and search directory listings for Conception Bay North";
...
<div class="breadcrumbs"><a href="index.php">Home</a> >> <a href="directory.php">Directory</a> >></div>
...
<div class="page_section">
    <div class="page_intro_2">
        <div class="shareRight">
            <?php 
                ...
                include_share_buttons("http://www.cbwire.ca/directory.php", "Directory on cbwire.ca");
            ?>
        </div>
        Directory</div> 
    ...
    <script type="text/javascript">
        ...
        <div id="slider2">
            <a href="cat.php?in=381"><img src="imgs/fire.jpg" class="imgMain" id="imgMain0" style="display:inline;"></a>
            <div class="clear"></div>
        </div>
        <div class="center_column"> 
            <div class="page_subtitle">Welcome</div>        
            <div class="quote">
                Use this page to browse businesses and organizations in Conception Bay North. 
                <a href="update_listing_pre.php">Click here</a> to add your listing here for free.
            </div>
            <div class="quote_credit"></div>
            <br><br>
            <div class="page_subtitle">Search Directory</div>  
            <form id="mainsearch_form" name="mainsearch_form" method="post" action="listall.php?a=directory" enctype="multipart/form-data">
        ...
        <div class="secondRow">
            ...
            <div class="dataColumnLarge">
                <?php include_once "directory_highlights.php"; ?>
            </div>   
        </div>
</div>
